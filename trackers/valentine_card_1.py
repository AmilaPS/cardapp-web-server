...
if __name__ == '__main__':
    ...
    caps = {
        "right_img": cv2.VideoCapture(os.path.join(templates_dir, 'tmpl_1786028991309_right.mp4')),
        "middle_img": cv2.VideoCapture(os.path.join(templates_dir, 'tmpl_1786028991309_middle.mp4')),
        "left_img": cv2.VideoCapture(os.path.join(templates_dir, 'tmpl_1786028991312_left.mp4')),
        "htext_img": cv2.VideoCapture(os.path.join(templates_dir, 'tmpl_1786028991312_heart_text.mp4')),
        "himage_img": cv2.VideoCapture(os.path.join(templates_dir, 'tmpl_1786028991312_heart_image.mp4')),
    }
    imgs = {
        ...
        "htext_img": cv2.imread(sys.argv[5], cv2.IMREAD_UNCHANGED),
        "himage_img": cv2.imread(sys.argv[6], cv2.IMREAD_UNCHANGED),
    }
    
    if imgs["table_img"] is None: sys.exit(1)
    
    rendering_order = ["right_img", "middle_img", "left_img", "htext_img", "himage_img"]
