...
if __name__ == '__main__':
    ...
    caps = {
        "right2_img": cv2.VideoCapture(os.path.join(templates_dir, 'tmpl_1786333686192_right.mp4')),
        "middle2_img": cv2.VideoCapture(os.path.join(templates_dir, 'tmpl_1786333686197_middle.mp4')),
        "left2_img": cv2.VideoCapture(os.path.join(templates_dir, 'tmpl_1786333686202_left.mp4')),
        "heart_text2_img": cv2.VideoCapture(os.path.join(templates_dir, 'tmpl_1786333686202_heart_text.mp4')),
        "heart_image2_img": cv2.VideoCapture(os.path.join(templates_dir, 'tmpl_1786333686203_heart_image.mp4')),
    }
    imgs = {
        "table_img": cv2.imread(sys.argv[1], cv2.IMREAD_UNCHANGED),
        "right2_img": cv2.imread(sys.argv[2], cv2.IMREAD_UNCHANGED),
        "middle2_img": cv2.imread(sys.argv[3], cv2.IMREAD_UNCHANGED),
        "left2_img": cv2.imread(sys.argv[4], cv2.IMREAD_UNCHANGED),
        "heart_text2_img": cv2.imread(sys.argv[5], cv2.IMREAD_UNCHANGED),
        "heart_image2_img": cv2.imread(sys.argv[6], cv2.IMREAD_UNCHANGED),
    }
    
    if imgs["table_img"] is None: sys.exit(1)
    
    rendering_order = ["right2_img", "middle2_img", "left2_img", "heart_text2_img", "heart_image2_img"]
